...
}, g = (e, t, i) => t.has(e) || m("Cannot " + i), r = (e, t, i) => (g(e, t, "read from private field"), i ? i.call(e) : t.get(e)), w = (e, t, i) => t.has(e) ? m("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), c = (e, t, i, h) => (g(e, t, "write to private field"), t.set(e, i), i), s;
let a = class extends y(V, void 0) {
  constructor() {
    super(...arguments), this._numericValue = 16, this._unit = "px", this._customValue = "", this._showToggle = !1, this._enabled = !0, w(this, s, ""), this.readonly = !1, this._min = 0, this._max = 100, this._step = 1;
  }
  set value(e) {
    const t = e ?? "";
