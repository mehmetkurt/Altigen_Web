...
var x = Object.defineProperty, b = Object.getOwnPropertyDescriptor, m = (e) => {
  ...
  for (var u = r > 1 ? void 0 : r ? b(t, i) : t, s = e.length - 1, o; s >= 0; s--)
    (o = e[s]) && (u = (r ? o(t, i, u) : o(u)) || u);
  return r && u && x(t, i, u), u;
}, g = (e, t, i) => t.has(e) || m("Cannot " + i), h = (e, t, i) => (g(e, t, "read from private field"), i ? i.call(e) : t.get(e)), $ = (e, t, i) => t.has(e) ? m("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), d = (e, t, i, r) => (g(e, t, "write to private field"), t.set(e, i), i), n;
let a = class extends y(V, void 0) {
  ...
  set value(e) {
    const t = e ?? "";
    t === h(this, n) && h(this, n) !== "" || (d(this, n, t), this._parseValue(h(this, n)));
  }
  get value() {
    return h(this, n);
  }
  ...
  _parseValue(e) {
    ...
    try {
      if (e && e.trim().startsWith("{")) {
        ...
        typeof s == "object" && s !== null && (t = s.value ? String(s.value) : "", i = s.enabled ?? !0);
      }
    } catch {
    }
    ...
    if (u) {
      const s = t.substring(0, t.length - u.length), o = parseFloat(s);
      if (!isNaN(o)) {
  ...
  _updateValue() {
    ...
    h(this, n) !== i && (d(this, n, i), this.dispatchEvent(new CustomEvent("change", { bubbles: !0, composed: !0 })));
  }
  _onUnitChange(e) {
    e.stopPropagation();
