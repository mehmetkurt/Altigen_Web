import { LitElement as h, html as y, css as g, state as p, property as f, customElement as d } from "@umbraco-cms/backoffice/external/lit";
import { UmbElementMixin as v } from "@umbraco-cms/backoffice/element-api";
var b = Object.defineProperty, _ = Object.getOwnPropertyDescriptor, c = (e, t, u, a) => {
  for (var l = a > 1 ? void 0 : a ? _(t, u) : t, i = e.length - 1, s; i >= 0; i--)
    (s = e[i]) && (l = (a ? s(t, u, l) : s(l)) || l);
  return a && l && b(t, u, l), l;
};
let o = class extends v(h) {
  constructor() {
  ...
  willUpdate(e) {
    var t;
    (e.has("value") || e.has("config")) && (console.group("TextAlignment Debug"), console.log("Current Config:", this.config), console.log("Raw Output Type:", (t = this.config) == null ? void 0 : t.outputType), console.groupEnd(), this._syncTypeWithConfig(), this._updateDisplayValue());
  }
  _syncTypeWithConfig() {
    var t, u, a, l;
    ...
    if (Array.isArray(e) && (e = e[0]), this._value.type !== e) {
      ...
      if (e === "Css Class" || Array.isArray(e) && e[0] === "Css Class") {
        const s = {
          ...
          center: ((u = this.config) == null ? void 0 : u.centerValue) ?? "center",
          right: ((a = this.config) == null ? void 0 : a.rightValue) ?? "right",
          justify: ((l = this.config) == null ? void 0 : l.justifyValue) ?? "justify"
        };
        i === "left" ? i = s.left : i === "center" ? i = s.center : i === "right" ? i = s.right : i === "justify" && (i = s.justify);
      }
      this._value = {
        value: i,
        type: e
  ...
  _updateDisplayValue() {
    var i, s, n, r;
    const e = this._value.value, t = ((i = this.config) == null ? void 0 : i.leftValue) ?? "left", u = ((s = this.config) == null ? void 0 : s.centerValue) ?? "center", a = ((n = this.config) == null ? void 0 : n.rightValue) ?? "right", l = ((r = this.config) == null ? void 0 : r.justifyValue) ?? "justify";
    e === t ? this._displayValue = t : e === u ? this._displayValue = u : e === a ? this._displayValue = a : e === l ? this._displayValue = l : this._displayValue = e;
  }
  _setValue(e) {
    var a, l, i, s, n;
    const t = {
    ...
    let u = ((n = this.config) == null ? void 0 : n.outputType) ?? "Default (Inline Style)";
    Array.isArray(u) && (u = u[0]), this._value = {
      value: t[e],
      type: u
  ...
  render() {
    var i, s, n, r;
    const e = ((i = this.config) == null ? void 0 : i.leftValue) ?? "left", t = ((s = this.config) == null ? void 0 : s.centerValue) ?? "center", u = ((n = this.config) == null ? void 0 : n.rightValue) ?? "right", a = ((r = this.config) == null ? void 0 : r.justifyValue) ?? "justify", l = this._value.value;
    return y`
            <div class="wrapper">
