...
var x = Object.defineProperty, m = Object.getOwnPropertyDescriptor, h = (t, i, s, u) => {
  for (var e = u > 1 ? void 0 : u ? m(i, s) : i, a = t.length - 1, n; a >= 0; a--)
    (n = t[a]) && (e = (u ? n(i, s, e) : n(e)) || e);
  return u && e && x(i, s, e), e;
};
...
var b = Object.defineProperty, y = Object.getOwnPropertyDescriptor, c = (t, i, s, u) => {
  for (var e = u > 1 ? void 0 : u ? y(i, s) : i, a = t.length - 1, n; a >= 0; a--)
    (n = t[a]) && (e = (u ? n(i, s, e) : n(e)) || e);
  return u && e && b(i, s, e), e;
};
let l = class extends f(d) {
  ...
  _update(t, i) {
    let s = i;
    this._value.unit !== "custom" && (s = i.replace(/[^0-9.,]/g, "")), this._value.isLinked ? this._value = {
      ...this._value,
      top: s,
      right: s,
      bottom: s,
