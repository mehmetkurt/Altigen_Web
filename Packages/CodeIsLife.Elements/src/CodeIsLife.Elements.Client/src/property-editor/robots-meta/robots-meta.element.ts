...
@customElement('codeislife-robots-meta')
export default class CodeIsLifeRobotsMetaElement extends UmbElementMixin(LitElement) {
...
declare global {
    interface HTMLElementTagNameMap {
        'codeislife-robots-meta': CodeIsLifeRobotsMetaElement;
    }
}
